...
?>
  ...
  <body>
    ...
    <!-- Navbar -->
    <nav class="navbar p-5 navbar-expand-lg  bg-dark">
      <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Warming Up</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="status_pesanan.php">STATUS PESANAN</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">DETAIL STATUS PESANAN</h3>
